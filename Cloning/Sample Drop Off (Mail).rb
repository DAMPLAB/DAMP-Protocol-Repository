...
class Protocol
  ...
  def main
    ...
    conc_data = show do
      title "Please determine and enter concentrations of the following items in M."
      note "Please determine and enter concentrations of the following items in M."
      warning "Do not enter concentration in ng/ul or any unit other than M."
